...
function onServerCreated()
{
   ...
   exec("./pttaCommands.cs");			// Bac's

   exec("./commands.cs");			// Modified by Bac's
   exec("./constants.cs");
   exec("./serverCmd.cs");			// Modified by Bac's
   exec("./adminCommands.cs");		// Modified by Bac's
   ...
   exec("./item.cs");
   exec("./staticShape.cs");
   exec("./weapon.cs");				// Modified by Bac's
   exec("./radiusDamage.cs");
   exec("./player.cs");				// Modified by Bac's
   exec("./brick.cs");
   ...
   exec("./Tools/Toolexec.cs");		// Deleted by Bac's, now reintroduced
   exec("./Weapons/Weaponexec.cs");
   //###################################
   //# End.
   //###################################

   exec("./movers.cs");				// Modified by Bac's
   exec("./particles.cs");
   exec("./bombexplosions.cs");
   exec("./bombradiusdamage.cs");
   exec("./message.cs");			// Modified by Bac's
   exec("./precipitation.cs");
   exec("./persistence.cs");		// Modified by Bac's
   exec("./showImages.cs");
